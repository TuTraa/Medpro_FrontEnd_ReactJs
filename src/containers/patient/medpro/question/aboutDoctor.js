            ...
            <>
                ...
                <div className='question'>
                    ...
                    <QuestionItem
                        ...
                        answer={'<p>Th&ocirc;ng tin b&aacute;c sĩ, cơ sở y tế được lấy từ c&aacute;c nguồn sau:</p><ul><li>Do b&aacute;c sĩ trực tiếp cung cấp</li><li>Do cơ sở y tế nơi b&aacute;c sĩ c&ocirc;ng t&aacute;c cung cấp</li><li>Dựa theo bằng cấp chuy&ecirc;n m&ocirc;n v&agrave; chứng chỉ h&agrave;nh nghề</li><li>Ch&uacute;ng t&ocirc;i thu thập bổ sung từ c&aacute;c nguồn th&ocirc;ng tin ch&iacute;nh thống kh&aacute;c như: website bệnh viện, trang tin chuy&ecirc;n ng&agrave;nh, c&aacute;c b&aacute;o c&aacute;o nghi&ecirc;n cứu,.. v&agrave; c&oacute; kiểm tra, đối chiếu, x&aacute;c thực.</li></ul><p>Về nguy&ecirc;n tắc, Medpro lu&ocirc;n nỗ lực để th&ocirc;ng tin về b&aacute;c sĩ đảm bảo sự tin cậy v&agrave; c&oacute; độ ch&iacute;nh x&aacute;c cao nhất. Tuy nhi&ecirc;n, ch&uacute;ng t&ocirc;i chưa đủ điều kiện để x&aacute;c thực tất cả th&ocirc;ng tin l&agrave; ch&iacute;nh x&aacute;c tuyệt đối hoặc kh&ocirc;ng c&oacute; sai s&oacute;t n&agrave;o xảy ra. Đ&ocirc;i khi trong qu&aacute; tr&igrave;nh c&ocirc;ng t&aacute;c b&aacute;c sĩ thay đổi chức danh, vị tr&iacute; c&ocirc;ng việc, học h&agrave;m, học vị hoặc bằng cấp chứng chỉ chuy&ecirc;n m&ocirc;n m&agrave; hệ thống chưa kịp cập nhật.</p><div id="eJOY__extension_root" class="eJOY__extension_root_class" style="all: unset;">&nbsp;</div>'}
                    />
                    <QuestionItem
                        question={'Tôi phải làm thế nào để gặp được bác sĩ?'}
                        answer={'<p>Sau khi đặt kh&aacute;m qua Medpro, bạn nhận được Hướng dẫn chi tiết về thời gian, địa chỉ, h&igrave;nh thức để gặp b&aacute;c sĩ.&nbsp;</p><p>Ngo&agrave;i ra, hướng dẫn đi kh&aacute;m c&ograve;n cung cấp th&ocirc;ng tin hỗ trợ trước kh&aacute;m, trong khi đi kh&aacute;m v&agrave; sau kh&aacute;m cụ thể, chi tiết.</p><div id="eJOY__extension_root" class="eJOY__extension_root_class" style="all: unset;">&nbsp;</div>'}
                    />
                    <QuestionItem
